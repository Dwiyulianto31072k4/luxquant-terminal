...
from app.api.routes.admin_autotrade import router as admin_autotrade_router
...
app.include_router(agent_waitlist_router, prefix="/api/v1")
app.include_router(agent_disclaimer_router, prefix="/api/v1")

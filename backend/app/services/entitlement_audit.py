...
DRC_AGENT_MESSAGE = (
    ...
    "has its own considerations. Jaxx, CEO of Daily Rekom Crypto, has asked that "
    "automated trade execution not be offered to DRC members for now. We fully "
    "respect that decision and follow their direction for their members, so the "
    "Agent isn't available on your account. Everything else remains yours to use "
    "without limits.\n\n"

...
def build_editorial_pack(
    ...
    *,
    ...
    user = (
        ...
        "Caption: Write like a sharp human editor with room to actually explain something, NOT an AI "
        "summarising. 5 to 7 paragraphs, roughly 900-1400 characters of body text. Plain English, one idea "
        "per paragraph, sentence lengths varied — a short one after two long ones is what makes prose read "
        "like a person wrote it.\n"
        "Structure that earns the read:\n"
        "  (1) HOOK — the first ~80 characters carry the single most surprising true fact, stated flatly. "
        "Never a windup. Banned openers include 'In today's fast-paced world', 'In a groundbreaking move', "
        "'In an unprecedented', 'The world of crypto', 'As the dust settles'.\n"
        "  (2) THE SPECIFICS — the numbers, names, dates and quantities from the sources. Concrete detail IS "
        "the interest; a reader remembers '1,638 bitcoin' and forgets 'a significant amount'. Never round a "
        "figure the source gave precisely, and never reach for a figure the sources did not give.\n"
        "  (3) THE MECHANISM — how this actually works or why it happened. This is the paragraph most "
        "summaries skip and it is the one that makes a reader feel smarter for having read it. Explain the "
        "instrument, the rule, the incentive or the chain of cause, in the plainest words that stay accurate.\n"
        "  (4) WHO IS AFFECTED — name the parties and what changes for them concretely. Not 'the market' in "
        "the abstract: which desks, which holders, which issuers, which users.\n"
        "  (5) THE HONEST TENSION — what is genuinely unsettled, contested, or could go the other way, "
        "including the strongest point against the story's framing. Do not hedge for the sake of hedging and "
        "do not perform balance where the sources are one-sided; say plainly what is not yet known.\n"
        "  (6) CLOSE — land on a concrete detail or an open question the story itself raises. No summary of "
        "what you just said, no rallying line, no CTA.\n"
        "Craft rules: prefer the specific noun to the category ('Bank of Korea' over 'a central bank'); cut "
        "every sentence that would survive being deleted; no throat-clearing ('It is worth noting that'); no "
        "hedge stacking ('could potentially may'); no em dashes; no rhetorical questions in the body; do not "
        "start consecutive paragraphs with the same word. If external search results are provided, use only "
        "those whose published_date fits THIS event (see TIME RULES) and prefer the most recent figure among "
        "them; a result about an earlier occurrence is not context, it is a wrong number. If the sources are "
        "genuinely thin, write a shorter caption rather than padding it — inventing texture is worse than "
        "being brief. Do NOT include hashtags, a disclaimer, a call-to-action, an AI label, or a source line "

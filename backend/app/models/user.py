...
class User(Base):
    ...
    subscription_expires_at = Column(DateTime(timezone=True), nullable=True)  # NULL = lifetime or not subscribed
    subscription_granted_by = Column(Integer, nullable=True)  # admin user_id or NULL (self-pay)

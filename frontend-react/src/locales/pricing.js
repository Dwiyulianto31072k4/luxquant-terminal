...
export const pricingEn = {
  ...
  switch: "Switch",
  premium: "Premium",
  subtitle: "Full access to signals, execution, market intelligence, and research.",
  ...
  payment_desc: "USDT on BNB Smart Chain (BEP-20). Verified on-chain and activated automatically.",

...
export const paymentEn = {
  ...
  // Network warnings
  warning_bsc:
    "Make sure to use BNB Smart Chain (BEP-20) network. Sending via other networks will result in loss of funds.",
  warning_erc20:
    "Make sure to use Ethereum (ERC-20) network. Sending via other networks will result in loss of funds.",
  warning_trc20:
    "Make sure to use TRON (TRC-20) network. Sending via other networks will result in loss of funds.",
  warning_btc:
    "Make sure to send Bitcoin only to this address. Sending other tokens will result in loss of funds.",

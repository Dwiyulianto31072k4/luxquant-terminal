  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        // 403 here means no subscription. Leave the map null: which pairs were
        // called is the paid signal itself, so a free session must not learn it
        // from a badge, a filter or a heatmap border.
        if (!r.ok) return;

...
export function getTradingViewTheme(theme = getActiveTheme()) {
 ...
 const ink = cssChannelHex(
 "--ink",
 theme === "bright" ? "#0f172a" : "#ffffff"
 );
...
export function mountTradingViewEmbed(host, opts = {}) {
 ...
 shell.style.cssText = "height:100%;width:100%;background:" + (getTradingViewTheme().backgroundColor);

...
const CalendarHeatmapTab = ({ data, onDrill }) => {
 ...
 scale as the heatmaps. The small figure is wins/resolved. <span className="text-text-muted">Click any
 ...
 <span className={agg.wr >= 60 ? "text-profit/80" : agg.wr >= 50 ? "text-text-primary/55" : "text-loss/80"}>
 {agg.wr.toFixed(0)}%
 </span>{" "}
 · {agg.wins}/{agg.total}
 </span>

    ...
    return (
      <th
        ...
        className={`px-3 py-3 text-[10px] tracking-[0.18em] font-mono uppercase font-normal cursor-pointer hover:text-text-primary transition ${
          isActive ? "text-gold-primary" : "text-text-primary/40"
        } text-${align}`}
      >
              ...
              {sorted.map((p) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className={`px-3 py-2.5 text-right font-mono tabular-nums ${p.win_rate >= 75 ? "text-emerald-400" : p.win_rate >= 50 ? "text-text-primary/75" : "text-red-400"}`}>
                    ...
                    <td className={`px-3 py-2.5 text-right font-mono tabular-nums font-semibold ${ev == null ? "text-text-primary/30" : pos ? "text-emerald-400" : "text-red-400"}`}>

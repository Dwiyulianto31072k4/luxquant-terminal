...
const MarketDashboard = () => {
 ...
 <th className="px-4 py-3 text-left text-xs text-text-muted uppercase tracking-wider">Symbol</th>
 <th className="px-4 py-3 text-right text-xs text-text-muted uppercase tracking-wider">Funding Rate</th>
 </tr>
 </thead>
 <tbody>

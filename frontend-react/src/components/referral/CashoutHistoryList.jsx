    ...
    >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-baseline gap-2 mb-1.5">
              ...
              <span
                ...
                style={{ color: "rgb(var(--fg))", fontFamily: "'Space Grotesk', sans-serif" }}
              >
      ...
      {expanded && (
        <div
          ...
          style={{
            borderColor: "rgb(var(--accent) / 0.06)",
        ...
        >
          <div className="space-y-3 text-xs">
            ...
            {/* Destination */}
            {item.destination_telegram && (
              <DetailRow label="Telegram" value={`@${item.destination_telegram}`} mono />
            )}

            {/* User note */}
            {item.destination_note && <DetailRow label="Your note" value={item.destination_note} />}
            ...
            {/* TX hash */}
            {item.tx_hash && <DetailRow label="TX Hash" value={item.tx_hash} mono />}
          </div>

...
const CashoutRequestModal = ({ isOpen, onClose, availableBalance = 0, onSuccess }) => {
  ...
  const inputCls =
    "w-full rounded-xl border border-ink/[0.08] bg-surface-raised px-4 py-3.5 text-text-primary outline-none transition-colors focus:border-line/40 disabled:opacity-50";

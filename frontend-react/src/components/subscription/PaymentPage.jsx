...
const PaymentPage = () => {
 ...
 height: "600px",
 background:
 "radial-gradient(ellipse, rgb(var(--accent) / 0.04) 0%, transparent 70%)",
 }}
 />
 </div>
 ...
 onFocus={(e) =>
 (e.target.style.borderColor = "rgb(var(--accent) / 0.3)")
 }
 onBlur={(e) =>
 (e.target.style.borderColor = "rgb(var(--accent) / 0.08)")
 }
 />
 </div>

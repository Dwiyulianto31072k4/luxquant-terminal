...
const SubscriptionStatus = ({ compact = false }) => {
 ...
 return (
 <span className="px-2 py-0.5 rounded text-[10px] font-bold"
 style={{ background: 'rgb(var(--accent) / 0.15)', color: 'rgb(var(--accent))', border: '1px solid rgb(var(--line) / 0.3)' }}>
 PREMIUM
 </span>
 );
 }
 ...
 style={{ background: 'linear-gradient(to right, rgb(var(--accent)), rgb(var(--accent)))', color: 'rgb(var(--surface))' }}
 >
 Upgrade Sekarang
 </button>
 </div>

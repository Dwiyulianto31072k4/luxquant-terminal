...
Could you please help me complete the payment? Thanks!`;
  ...
  const header = (
    <div className="flex items-center gap-3">
      <span className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-gold-primary/12 text-gold-primary ring-1 ring-gold-primary/28">
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="md" padded={false} header={header} footer={footer}>
      <div className="px-6 py-4 sm:px-7">
        {/* Plan summary */}
        <div className="relative mb-4 overflow-hidden rounded-xl border border-line/10 bg-surface-raised px-4 py-3">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="shrink-0 text-right">
              ...
              <p className="mt-0.5 text-base font-bold tabular-nums text-gold-primary">
        ...
        <textarea
          ...
          rows={9}
          className="w-full resize-none rounded-xl border border-line/10 bg-surface-raised px-4 py-3 font-mono text-[12px] leading-relaxed text-text-primary outline-none transition-colors focus:border-line/30"

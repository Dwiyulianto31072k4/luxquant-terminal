...
const PremiumModal = ({ isOpen, onClose }) => {
 ...
 style={{
 background: isHighlighted ? "linear-gradient(168deg, rgb(var(--accent) / 0.16) 0%, #0c0708 50%)" : "#0c0708",
 borderColor: isHighlighted ? "rgb(var(--accent) / 0.3)" : "rgb(var(--ink) / 0.06)",
 }}
 >
 {badge && (
 <div className="absolute -top-2.5 left-1/2 z-10 -translate-x-1/2">
 <div className="rounded-full px-3 py-0.5 text-[9px] font-bold uppercase tracking-wider" style={{ background: "linear-gradient(135deg, rgb(var(--accent)), #a07c2e)", color: "rgb(var(--surface))" }}>
 {badge}
 </div>
 </div>
 )}
 ...
 <div className="mb-4 h-px" style={{ background: "linear-gradient(90deg, rgb(var(--accent) / 0.08), transparent)" }} />

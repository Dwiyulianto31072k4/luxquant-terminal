...
const PricingPage = () => {
  ...
  return (
    <div className="relative overflow-hidden min-h-screen">
      {/* Background effects - Sekarang akan selalu dirender bahkan saat loading! */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-16">
        {/* Jika masih loading, tampilkan spinner saja di tengah layout */}
        {loading ? (
          ...
          /* Jika loading selesai, tampilkan seluruh konten */
          <>
            {/* Header */}

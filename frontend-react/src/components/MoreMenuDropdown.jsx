...
const MoreMenuDropdown = ({
  ...
  const groups = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: Icon.terminal,
          label: "Terminal",
          desc: "Research desk · confluence, scan, derivatives",
        },
        {
          path: "/ai-arena",
          icon: Icon.aiResearch,
          label: t("mfm.ai_arena", { defaultValue: "AI Research" }),
          desc: "BTC Compass · 24h outlook & projection",
        },
        {
          path: "/autotrade",
          icon: Icon.autotrade,
      ...
      items: [
        {
          ...
          icon: Icon.markets,
          label: t("mfm.markets"),
          desc: "Prices across every pair",
        },
        {
          path: "/market-pulse",
          icon: Icon.pulse,
          label: t("mfm.pulse"),
          desc: "Real-time sentiment & momentum",
        },
        {
          path: "/onchain",
          icon: Icon.onchain,
          label: t("mfm.onchain"),
          desc: "Wallet & whale activity",
        },
        {
          path: "/money-flow",
          icon: Icon.moneyFlow,
          label: t("mfm.money_flow", { defaultValue: "Money Flow" }),
          desc: "Sector & capital rotation",
        },
        {
          path: "/delistings",
          icon: Icon.delist,
          label: t("mfm.delistings", { defaultValue: "Delistings" }),
          desc: "Exchange delist alerts · pump tracker",
        },
        {
          path: "/bitcoin",
          icon: Icon.bitcoin,
          label: t("mfm.bitcoin"),
          desc: "BTC dominance & macro view",
        },
        {
          path: "/crypto-news",
          icon: Icon.news,
          label: t("mfm.news"),
          desc: "Curated market headlines",
        },
        {
          path: "/calendar",
          icon: Icon.calendar,
          label: t("mfm.calendar"),
          desc: "Macro events & releases",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          label: t("mfm.performance", { defaultValue: "Performance" }),
          desc: "Track record, daily & research",
        },
        {
          path: "/journal",
          icon: Icon.journal,
          label: t("mfm.journal"),
          desc: "Log & review your trades",
        },
        {
          path: "/portfolio",
          icon: Icon.portfolio,
          label: t("mfm.portfolio"),
          desc: "PnL, equity & holdings",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          path: "/api-keys",
          icon: Icon.apiKeys,
          label: t("mfm.api_keys", { defaultValue: "API Keys" }),
          ...
          <span className="flex items-center gap-2">
            <span
              className={`text-[13px] leading-tight truncate transition-colors ${
                active ? "text-accent" : "text-text-primary/90 group-hover:text-text-primary"
              }`}
            >
              {item.label}
            </span>
  ...
  return (
    <div ref={wrapRef} className="relative" onMouseEnter={openNow} onMouseLeave={closeSoon}>
      ...
      >
        <div className="lux-warm-panel relative w-[720px] max-w-[92vw] rounded-xl border border-ink/[0.12] shadow-2xl shadow-scrim/30 overflow-hidden">

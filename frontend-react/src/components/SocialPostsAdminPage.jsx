...
const GenerationConsole = ({
 ...
 ? "shadow-[0_0_40px_-12px_rgb(var(--accent) / 0.45)]"
 : "";
...
const SocialPostsAdminPage = () => {
 ...
 <div>
 <h1 className="font-display text-2xl lg:text-3xl font-semibold text-text-primary tracking-tight">Social Posts</h1>

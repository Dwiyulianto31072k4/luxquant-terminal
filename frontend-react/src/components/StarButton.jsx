...
const StarButton = ({ signalId, isStarred: initialStarred, onToggle }) => {
  ...
  return (
    <div className="relative">
      ...
      {showTooltip && (
        <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 px-3 py-1.5 bg-bg-card border border-line/30 rounded-lg shadow-xl z-50 whitespace-nowrap animate-fadeIn">

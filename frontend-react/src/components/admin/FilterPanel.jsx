  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(to right, transparent, rgb(var(--ink) / 0.05), transparent)",
        }}
      />
      ...
      >
        <div className="flex items-center gap-2.5">
          <FilterIcon
            size={14}
            style={{ color: activeCount > 0 ? "rgb(var(--ink) / 0.75)" : "rgb(var(--ink) / 0.4)" }}
          />
        ...
        <div className="flex items-center gap-2">
          {activeCount > 0 && (
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.background = tint(palette.red[400], 0.14))
              }
              onMouseLeave={(e) =>
                (e.currentTarget.style.background = tint(palette.red[400], 0.06))
              }
            >
              <XCircleIcon size={10} />
              Clear all
      ...
      {/* Body */}
      {expanded && (
        <div className="px-4 pb-4 pt-3" style={{ borderTop: `1px solid ${surface.base.border}` }}>

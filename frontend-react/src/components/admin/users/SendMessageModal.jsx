...
const TEMPLATES = [
  {
    id: "reminder",
    label: "Reminder",
    text: "Hi! Just a friendly reminder from LuxQuant. Let us know if you have any questions \u2014 we're here to help.",
  },
  {
    id: "billing",
    label: "Billing",
    text: "Hi! This is a reminder that your LuxQuant subscription payment is due. Please renew to keep your VIP access active. Reach out if you need help.",
  },
  {
    id: "promo",
    label: "Promo",
    text: "Hi! \uD83C\uDF89 Special offer from LuxQuant just for you. Renew or upgrade now to keep getting real-time VIP signals and analysis. Limited time \u2014 don't miss out!",
  },
  {
    id: "join_vip",
    label: "Join VIP",
    text: "Hi! Your LuxQuant VIP subscription is active. Join the VIP signal group to get real-time signals, market announcements, and exclusive analysis.",
  },
];
    ...
    <Modal isOpen onClose={onClose} size="md">
      <div className="min-w-0">
        ...
        <p className="mb-3 text-xs text-text-muted">
          DM <strong className="text-text-primary">@{user?.username}</strong> directly through the
          LuxQuant bot.
        </p>

  ...
  return (
    <Modal isOpen onClose={onClose} size="md" title="Set role">
      <div className="space-y-4">
        ...
        {error && (
          <p className="text-[11px] text-loss bg-negative/10 border border-negative/20 rounded-md px-3 py-2">
            {error}
          </p>
        )}
      </div>
      ...
      <ModalFooter>
        ...
        <GoldButton onClick={handleSubmit} disabled={loading || unchanged} className="flex-1">

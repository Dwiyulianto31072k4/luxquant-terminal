...
export const EmailIcon = ({ size = 16, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M3.5 7.5l7.4 4.9a2 2 0 0 0 2.2 0l7.4-4.9"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
...
export const SendIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M21.4 3.6a1 1 0 0 0-1.05-.23L3.9 9.2c-.94.34-.9 1.7.06 1.98l6.14 1.77 1.77 6.14c.28.96 1.64 1 1.98.06l5.83-16.45a1 1 0 0 0-.28-1.1z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
      d="M21.4 3.6L10.6 12.7M21.4 3.6L15.6 20a.7.7 0 0 1-1.32.05l-2.02-6.02-6.02-2.02A.7.7 0 0 1 6.3 8.4L21.4 3.6z"
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const BroadcastIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M16.24 7.76a6 6 0 0 1 0 8.49M7.76 16.24a6 6 0 0 1 0-8.49"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M20.49 4.93a10 10 0 0 1 0 14.14M3.51 19.07a10 10 0 0 1 0-14.14"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinecap="round"
      opacity="0.5"
...
export const MessageCircleIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M12 3a9 9 0 0 0-8 13.1L3 21l4.9-1a9 9 0 1 0 4.1-17z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
      d="M12 3a9 9 0 0 0-8 13.1L3 21l4.9-1A9 9 0 1 0 12 3z"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinejoin="round"
    />
...
export const BellIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M18 9A6 6 0 0 0 6 9c0 5-2 6.5-2 6.5h16S18 14 18 9z"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinejoin="round"
    />
...
export const UploadIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    />
    <path
      d="M12 15V3M7.5 7.5L12 3l4.5 4.5"
      stroke="currentColor"
      strokeWidth="2.1"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const EditIcon = ({ size = 12, ...props }) => (
  <Svg size={size} {...props}>
    ...
    />
    <path
      d="M17.5 2.6a2 2 0 0 1 2.9 2.9L11 15l-4 1 1-4 9.5-9.4z"
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const TrashIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M6 7h12l-1 13a2 2 0 0 1-2 1.8H9A2 2 0 0 1 7 20L6 7z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
      d="M4 6h16M9 6V4.5A1.5 1.5 0 0 1 10.5 3h3A1.5 1.5 0 0 1 15 4.5V6m2 0l-1 14a2 2 0 0 1-2 1.9H8A2 2 0 0 1 6 20L5 6"
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const RefreshIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    />
    <path
      d="M19.4 9A8 8 0 0 0 5.6 6.2L3 10m18 4l-2.6 3.8A8 8 0 0 1 4.6 15"
      stroke="currentColor"
      strokeWidth="2.1"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const EyeIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M1.5 12S5 5 12 5s10.5 7 10.5 7S19 19 12 19 1.5 12 1.5 12z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
...
export const AlertTriangleIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M10.3 3.9L2 18a2 2 0 0 0 1.7 3h16.6a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
...
export const UsersIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M14 14c.9-.4 1.9-.6 3-.6 3.2 0 5.5 2 5.5 4.6v1.2H15"
      fill="currentColor"
      opacity="0.55"
    />
...
export const ShieldIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M12 2.5l8 3v6.5c0 5.5-8 9.5-8 9.5s-8-4-8-9.5V5.5l8-3z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
...
export const HistoryIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M3.5 15A9 9 0 1 0 5.6 5.6L2 9"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ActivityIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M3 12h3.5l2.5 7 4-16 2.5 9H21"
      stroke="currentColor"
      strokeWidth="2.3"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const StarIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M12 2.5l2.9 5.9 6.5.95-4.7 4.6 1.1 6.45L12 17.4l-5.8 3.05 1.1-6.45L2.6 9.35l6.5-.95L12 2.5z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
...
export const SparklesIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M19 3l.7 1.9L21.5 5.6l-1.8.7L19 8l-.7-1.7L16.5 5.6l1.8-.7L19 3zM5 15l.7 1.9L7.5 17.6l-1.8.7L5 20l-.7-1.7L2.5 17.6l1.8-.7L5 15z"
      fill="currentColor"
      opacity="0.6"
    />
  </Svg>
...
export const ZapIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M13 2L3 14h8l-1 8 11-13h-8l0-7z"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinejoin="round"
    />
...
export const FlameIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M12 2.5c.5 2.5 2 4.5 3.7 6.2C17.4 10.4 19 12.4 19 15a7 7 0 1 1-14 0c0-1.2.4-2.3 1-3a2.5 2.5 0 0 0 2.5 2.5A2.5 2.5 0 0 0 11 12c0-1.4-.5-2-1-3-1-2.1-.2-4 2-6z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
...
export const GiftIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M20 12v9H4v-9M2 7.5h20V12H2zM12 21V7.5"
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M12 7.5H7.7a2.2 2.2 0 1 1 0-4.5C10.7 3 12 7.5 12 7.5zM12 7.5h4.3a2.2 2.2 0 1 0 0-4.5C13.3 3 12 7.5 12 7.5z"
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const CrownIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M2.5 7l4 5 3.5-6.5L13.5 12l4-5v11a2 2 0 0 1-2 2H4.5a2 2 0 0 1-2-2V7z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
      d="M2.5 7l4 4.5L12 4l5.5 7.5L21.5 7v10.5a1.8 1.8 0 0 1-1.8 1.8H4.3a1.8 1.8 0 0 1-1.8-1.8V7z"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const DollarIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M15 8.5H10.7a2.2 2.2 0 0 0 0 4.4h2.6a2.2 2.2 0 0 1 0 4.4H9M12 6.5v11"
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const WalletIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M3 8a2 2 0 0 1 2-2h13v3M3 8v10a2 2 0 0 0 2 2h14a1 1 0 0 0 1-1v-3M21 12v3h-4a1.5 1.5 0 0 1 0-3h4z"
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ReceiptIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M5 3l2 1.5L9 3l2 1.5L13 3l2 1.5L17 3v18l-2-1.5L13 21l-2-1.5L9 21l-2-1.5L5 21V3z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
...
export const TagIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M3 3h8.5L21 12.5a1.8 1.8 0 0 1 0 2.5l-6 6a1.8 1.8 0 0 1-2.5 0L3 11.5V3z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
...
export const FlagIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M5 4s1-1 4-1 5 2 8 2 4-1 4-1v9s-1 1-4 1-5-2-8-2-4 1-4 1V4z"
      fill="currentColor"
      opacity={BODY}
    />
    <path
      d="M5 21V3s1-1 4-1 5 2 8 2 4-1 4-1v9s-1 1-4 1-5-2-8-2-4 1-4 1"
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ProviderIcon = ({ provider, size = 14, className = "" }) => {
  switch (provider) {
    ...
    case "local":
      return (
        <EmailIcon size={size} className={className} style={{ color: "rgb(var(--fg-muted))" }} />
      );
    default:
      return null;
  }
...
export const LambdaGlyph = ({ size = 18, ...props }) => (
  <Svg size={size} {...props}>
    <path
      d="M5 21L11.2 5.5Q12 3.8 12.8 5.5L19 21"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const UsersRingIcon = ({ size = 14, ...props }) => (
  <Svg size={size} {...props}>
    ...
    <path
      d="M6 18.2c0-2.9 2.7-4.7 6-4.7s6 1.8 6 4.7"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />

...
import { DownloadIcon, StarIcon, BanIcon, SendIcon, CloseIcon, ChevronDownIcon } from "./Icons";
...
export const BulkActionBar = ({
  ...
  const handleRevokeClick = () => {
    if (!onRequestConfirm) {
      ...
      if (
        window.confirm(`Revoke subscription for ${subscriberCount} user(s)? This cannot be undone.`)
      ) {
              ...
              {templates
                ...
                .map((t, idx) => (
                  <button
                    ...
                    style={idx > 0 ? { borderTop: "1px solid rgb(var(--ink) / 0.04)" } : {}}
                  >

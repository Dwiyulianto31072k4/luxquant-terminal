...
const StatCard = ({ label, value, accent, Icon }) => (
 ...
 style={{ background: 'linear-gradient(to right, transparent, rgb(var(--accent) / 0.2), transparent)' }} />
...
const CampaignCard = ({ campaign, onEdit, onDelete }) => {
 ...
 {metadataKeys > 0 && (
 <span className="px-2 py-0.5 rounded font-medium"
 style={{ background: 'rgb(var(--accent) / 0.06)', color: 'rgb(var(--accent))', border: '1px solid rgb(var(--line) / 0.22)' }}>
...
export const MarketingTab = ({ onRefreshStats }) => {
 ...
 <StatCard label="Total Budget" value={formatCurrency(totalBudget)} accent="rgb(var(--accent))" />

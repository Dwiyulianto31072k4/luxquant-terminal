  ...
  <div className="flex items-center gap-2">
    ...
    <input
      ...
      onChange={(e) => {
        ...
        onChange(k, val !== "" && !isNaN(num) ? num : val);
      }}
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            ...
            >
              Line Items{" "}
              <span
                className="ml-1 lowercase tracking-normal"
            ...
            <button
              type="button"
              onClick={() =>
                setLineItems([...lineItems, { label: "", amount: 0, date: "", note: "" }])
              }
          ...
          {lineItems.length === 0 ? (
            <div
              className="rounded-lg py-4 text-center text-[10px]"
              style={{
                background: "rgb(var(--ink) / 0.015)",
                border: "1px dashed rgb(var(--ink) / 0.06)",

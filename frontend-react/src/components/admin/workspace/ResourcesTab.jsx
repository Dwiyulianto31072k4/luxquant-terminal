...
export const ResourcesTab = () => {
 ...
 style={{ background: 'linear-gradient(135deg, rgb(var(--accent)), rgb(var(--accent)) 50%, rgb(var(--accent)))' }}
 >
 ...
 <button onClick={() => setDeleteConfirm(r)} className="p-1.5 rounded-lg text-loss hover:bg-red-500/10" title="Delete">

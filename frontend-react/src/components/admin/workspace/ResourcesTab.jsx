                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3 min-w-0 max-w-[360px]">
                          ...
                          <div className="min-w-0">
                            ...
                            {r.author_name && (
                              <div className="text-[11px] text-text-primary/40 truncate">
                                {r.author_name}
                              </div>
                            )}
                          </div>
                      ...
                      <td className="px-4 py-3">
                        ...
                        >
                          <Pill
                            color={
                              r.status === "published" ? palette.green[400] : palette.amber[400]
                            }
                          >
                      ...
                      <td className="px-4 py-3">
                        <button
                          ...
                          style={{
                            color: r.is_featured ? palette.gold[300] : "rgb(var(--ink) / 0.2)",
                          }}
                        >
                          {r.is_featured ? "★" : "☆"}
                        </button>
                      </td>
                      <td className="px-4 py-3 text-text-primary/40 text-xs whitespace-nowrap">
      ...
      {deleteConfirm && (
        ...
        >
          ...
          >
            ...
            <p className="text-text-primary/50 text-sm text-center mb-5">
              "{deleteConfirm.title}" will be hidden from the hub.
            </p>
            <div className="flex gap-3">
              <button
                onClick={() => setDeleteConfirm(null)}
                className="flex-1 py-2.5 rounded-xl text-sm font-medium text-text-primary/70 hover:text-text-primary"
                style={{
              ...
              <button
                ...
                style={{
                  background: tint(palette.red[400], 0.2),

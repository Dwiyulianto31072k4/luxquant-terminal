    ...
    setConfirmModal({
      ...
      onConfirm: async () => {
        try {
          ...
          showToast(e?.response?.data?.detail || "Approval failed. Please try again.", "error");
          throw e;
        }
      },
    });
    ...
    setConfirmModal({
      ...
      onConfirm: async () => {
        try {
          ...
          showToast(e?.response?.data?.detail || "Cancel failed. Please try again.", "error");
          throw e;
        }
      },
    });
    ...
    setConfirmModal({
      ...
      onConfirm: async () => {
        try {
          ...
          showToast(e?.response?.data?.detail || "Bulk cancel failed. Please try again.", "error");
          throw e;
        }
      },
    });

...
export const MODE_GUIDES = {
  ...
  full_tp: {
    ...
    title: "Runners",
    oneLiner: "The calls posted to the Runners topic: each cleared two bars when it was called \u2014 one of the two runner tags, and the top 30% of the last seven days\u2019 Edge.",
    does: "Keeps calls that wore one of the two runner tags at publish AND sat in the top 30% of the last seven days\u2019 Edge when they were called \u2014 decided once, the same decision that posts them to the Runners topic. A call chosen stays chosen. Runner tags are recalculated from closed calls since 10 Mar 2026, so which new calls qualify can change as the record grows. Sorts by Edge, then newest.",
    see: "A shorter list. How many depends on the week: the bar is the top 30% of the trailing seven days, so a strong day can send more through and a quiet one none. Runners carrying the #1 runner tag are marked Top Runner \u2014 the strongest group in our tests. The day tab only picks which calls to show. They stay here after TP1; Open (hasn\u2019t hit yet) is a chip, not this mode.",
    ...
    changes: "Runner tags (either of two) · top 30% Edge · sort Edge → Called. Status, search and the day tab stay.",
    steps: [

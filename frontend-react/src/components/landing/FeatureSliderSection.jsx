...
const FeatureSliderSection = () => {
 ...
 <span className="text-accent font-mono text-[9px] uppercase tracking-[0.3em]">Core Technology</span>
 </div>
 <h2 className="font-display text-3xl lg:text-5xl font-bold text-text-primary mb-4">
 Interactive <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-ink to-accent">Terminal Preview</span>
 </h2>
 ...
 >
 <div className={`transition-all duration-300 ${activeIdx === idx ? 'text-accent drop-shadow-[0_0_8px_rgb(var(--accent) / 0.5)] scale-110' : 'text-current opacity-60'}`}>
 {feat.icon}
 </div>

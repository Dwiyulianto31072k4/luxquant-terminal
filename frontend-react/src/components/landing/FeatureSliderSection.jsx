...
/* ================================================================
   FEATURES DATA
   Tetap dipertahankan apa adanya — pastikan path mockup masih sama.
   ================================================================ */
const FEATURES = [
  {
    id: 'signals',
    title: 'Algorithmic Signals',
    desc: 'High-conviction trade signals generated by our proprietary alpha models, with clear entry, take-profit, and stop-loss levels — delivered in real time.',
    macImg: '/mockups/mac-signals.png',
    phoneImg: '/mockups/phone-signals.png',
    icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 17l6-6 4 4 8-8M14 7h7v7" /></svg>
  },
  {
    id: 'ai',
    title: 'AI Researcher',
    desc: 'An always-on AI research desk that surfaces narratives, fundamentals, and on-chain anomalies — distilled into actionable briefings.',
  ...
  },
  {
    ...
    icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" /></svg>
  },
  {
    id: 'whale',

...
export default function GlobalNetworkSection(){
 ...
 return(
 <section id="global-network" style={{position:"relative",width:"100%",paddingTop:80,paddingBottom:0,background:"transparent",borderTop:"1px solid rgb(var(--accent) / 0.1)",overflow:"hidden"}}>
 <div ref={ref} style={{maxWidth:1200,margin:"0 auto",padding:"0 24px",position:"relative",zIndex:10}}>

 {/* Heading */}
 <div style={{textAlign:"center",marginBottom:48}}>
 <h2 style={{fontFamily:"'Space Grotesk',sans-serif",fontSize:"clamp(28px,5vw,52px)",fontWeight:700,color:"rgb(var(--fg))",margin:"0 0 16px",lineHeight:1.15}}>
 Serving Traders Across{" "}
 <span style={{background:"linear-gradient(to right,rgb(var(--accent)),rgb(var(--accent)),rgb(var(--accent)))",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>
 Every Continent.
 </span>
 </h2>
 ...
 {/* 1. Line going UP */}
 <div style={{width:1.5,height:60,background:"linear-gradient(to bottom,rgb(var(--accent) / 0),rgb(var(--accent)))"}}/>
 {/* 2. Dot */}
 <div style={{width:10,height:10,borderRadius:"50%",background:"rgb(var(--accent))",boxShadow:"0 0 10px rgb(var(--accent) / 0.6)",margin:"0 0 16px"}}/>
 {/* 3. Number */}
 <span style={{fontFamily:"'Space Grotesk',sans-serif",fontSize:"clamp(30px,5vw,54px)",fontWeight:700,color:i===0?"rgb(var(--accent))":"rgb(var(--accent))",lineHeight:1.1,textShadow:i===0?"0 0 20px rgb(var(--accent) / 0.3)":"none"}}>
 {s.value}
 </span>
 {/* 4. Label */}
 ...
 <div style={{width:32,height:32,border:"2px solid rgb(var(--line) / 0.2)",borderTopColor:"rgb(var(--accent))",borderRadius:"50%",animation:"globeSpin 1s linear infinite"}}/>
 </div>
 )}
 </div>
 </div>

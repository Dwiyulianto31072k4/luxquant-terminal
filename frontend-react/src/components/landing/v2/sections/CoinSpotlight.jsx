...
const C = {
 gold: "#e7c373", goldL: "rgb(var(--accent))", gold2: "rgb(var(--accent))", gold3: "#b8893c", gold4: "rgb(var(--accent))",
...
export default function CoinSpotlight() {
 ...
 Track any coin{" "}
 <span className="bg-gradient-to-r from-accent via-ink to-accent-dark bg-clip-text text-transparent">we've called.</span>
 </h2>
 ...
 {coinMeta?.sector && <span className="ml-2 font-mono text-[9px] uppercase tracking-wider text-text-muted">{coinMeta.sector}</span>}
 </p>
 ...
 boxShadow: "inset 0 1px 0 rgb(var(--ink) / 0.5), 0 0 6px rgb(var(--accent) / 0.35)",
 }}
 />
 </div>
 </div>

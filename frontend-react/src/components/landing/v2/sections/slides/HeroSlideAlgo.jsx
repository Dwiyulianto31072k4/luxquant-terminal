    ...
    <div className="flex w-full flex-col items-center text-center">
      ...
      <div className="relative mt-6 w-full max-w-[1040px] px-3 pb-3 sm:mt-8 sm:px-6 sm:pb-5 lg:mt-9">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_54%_50%_at_50%_40%,rgb(var(--accent) / 0.20),transparent_70%)] blur-2xl" />
          {/* soft diagonal light rays (left + right) */}
          <div
            className="absolute -top-10 left-[18%] h-[125%] w-[26%] rotate-[19deg] opacity-50 blur-[44px]"
            style={{
              background:
                "linear-gradient(180deg, rgba(240,216,144,0.16) 0%, rgb(var(--accent) / 0.05) 46%, transparent 74%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(240,216,144,0.13) 0%, rgb(var(--accent) / 0.04) 46%, transparent 74%)",
            }}
          />
          {/* warm floor glow */}
          <div className="absolute bottom-[7%] left-1/2 h-28 w-[64%] -translate-x-1/2 rounded-[50%] bg-accent/[0.10] blur-[80px]" />
          {/* horizon line */}
        ...
        <div className="relative mx-auto flex items-end justify-center">
          {/* iMac — center hero */}
          <IMacMockup
            src="/mockups/hero-mac-dashboard.webp?v=2"

...
export default function TerminalPreview() {
 ...
 >
 <div className={`transition-all duration-300 ${activeIdx === idx ? "scale-110 text-accent drop-shadow-[0_0_8px_rgb(var(--accent) / 0.5)]" : "text-current opacity-60"}`}>
 {t.icon}
 </div>
 ...
 …and much <span className="bg-gradient-to-r from-accent via-ink to-accent-dark bg-clip-text text-transparent">more</span>
 </h3>

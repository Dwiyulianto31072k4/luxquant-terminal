            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 flex justify-center lg:mt-9 lg:justify-start">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-2.5 rounded-full border border-white/15 bg-white/[0.03] px-6 py-3 text-sm font-semibold text-text-primary transition-all duration-300 hover:border-line/40 hover:bg-white/[0.06] hover:text-gold-primary"
                >

  ...
  return (
    <section className="relative z-10 mx-auto w-full max-w-6xl px-4 py-16 lg:px-8 lg:py-24">
      ...
      <div className="mb-16 text-center lg:mb-48">
        ...
        <h2 className="mt-7 text-3xl font-bold leading-tight tracking-tight text-white lg:text-[2.6rem]">
          Try Before You{" "}
            ...
            <div className="text-center lg:text-left">
              <div className="flex flex-col items-center gap-5 sm:flex-row sm:items-start sm:gap-7 lg:items-center lg:gap-8">
                ...
                <a
                  ...
                  className="group relative flex-shrink-0 rounded-2xl bg-white p-3 shadow-[0_8px_24px_rgba(0,0,0,0.45)] transition-transform duration-300 hover:-translate-y-0.5"
                ...
                <div className="min-w-0">
                  <p className="text-lg font-bold text-white sm:text-xl">Scan to join the channel</p>
              ...
              <div className="mt-8 flex justify-center lg:mt-9 lg:justify-start">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-2.5 rounded-full border border-white/15 bg-white/[0.03] px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:border-gold-primary/40 hover:bg-white/[0.06] hover:text-gold-primary"
                >

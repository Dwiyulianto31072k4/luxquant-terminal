...
const TickerBar = () => {
  ...
  return (
    <div className="w-full bg-scrim/60 backdrop-blur-md border-b border-ink/08 overflow-hidden h-10 flex items-center">
  ...
  return (
    ...
    >
      ...
      >
                ...
                <div className="relative h-full bg-surface-raised rounded-md border border-ink/10 p-6 lg:p-8 overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 lg:bottom-8 lg:left-8 lg:right-8 flex items-center justify-between pt-4 border-t border-ink/[0.06]">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-accent font-mono font-bold text-sm tabular-nums">
        ...
        <button
          onClick={goPrev}
          className="hidden lg:flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 w-9 h-9 items-center justify-center rounded-md text-text-primary/40 hover:text-text-primary hover:bg-ink/[0.03] border border-ink/10 hover:border-ink/12 transition-all"
        ...
        <button
          onClick={goNext}
          className="hidden lg:flex absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 w-9 h-9 items-center justify-center rounded-md text-text-primary/40 hover:text-text-primary hover:bg-ink/[0.03] border border-ink/10 hover:border-ink/12 transition-all"
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          ...
          <button
            onClick={goPrev}
            className="lg:hidden w-7 h-7 flex items-center justify-center text-text-primary/40 hover:text-text-primary transition-colors"
            aria-label="Previous"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
          ...
          {TESTIMONIALS.map((_, idx) => (
            <button
              ...
              className={`h-1.5 rounded-sm transition-all duration-300 ${
                idx === activeIdx ? "w-8 bg-accent" : "w-1.5 bg-ink/15 hover:bg-ink/30"
              }`}
...
const FAQItem = ({ q, a, isOpen, onClick }) => (
  <div
    className={`bg-surface-raised border rounded-md overflow-hidden mb-2 transition-all duration-300 ${
      isOpen ? "border-ink/12" : "border-ink/[0.06] hover:border-ink/[0.12]"
    }`}
  >
    <button
      ...
      onClick={onClick}
    >
      <span className="font-semibold text-text-primary pr-4 text-sm lg:text-base">{q}</span>
      <svg
        className={`w-4 h-4 flex-shrink-0 transition-all duration-300 ${
          isOpen
            ? "text-accent rotate-180"
            : "text-text-primary/40 group-hover:text-text-primary/70"
        }`}
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
...
const PromoFlyingCoins = ({ gainers }) => {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col gap-1 px-4 py-2.5 rounded-2xl border border-ink/12 shadow-[0_8px_32px_rgb(var(--scrim) / 0.35),0_0_15px_rgb(var(--accent) / 0.15)] min-w-[140px]"
        style={{
      ...
      >
        ...
        <span className="text-text-muted text-[9px] font-mono tracking-widest uppercase text-left mt-1 block">
          {labelText}
        </span>
      </div>
    </div>
...
const TelegramPromo = ({ gainers }) => {
  return (
    <div className="relative mt-16 overflow-visible">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-surface-secondary blur-[140px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative z-10">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-text-secondary mb-10 text-base lg:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
            ...
            <span className="text-text-primary font-mono">@LuxQuantSignal</span> for our free public
            channel. Real-time algorithm previews and selected high-probability calls — directly to
            your pocket.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <a
              ...
              className="group relative inline-flex items-center gap-2.5 px-7 py-3.5 rounded-md font-semibold text-sm transition-all hover:-translate-y-0.5 shadow-[0_4px_14px_rgb(var(--accent) / 0.25)] hover:shadow-[0_6px_18px_rgb(var(--accent) / 0.35)]"
              style={{
                background:
                  "linear-gradient(135deg, rgb(var(--accent)) 0%, rgb(var(--accent)) 50%, rgb(var(--accent)) 100%)",
        ...
        <div className="flex-1 flex justify-center lg:justify-end relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] bg-accent/10 blur-[80px] rounded-full pointer-events-none" />
...
const RuntimeCounter = () => {
  ...
  return (
    <div className="glass-card rounded-xl p-5 lg:p-6 border border-ink/10 col-span-2 lg:col-span-4">
 ...
 0%, 100% {
 box-shadow:
 0 0 6px rgb(var(--accent) / 0.85),
 0 0 12px rgb(var(--accent) / 0.55),
 0 0 20px rgb(var(--accent) / 0.3),
 inset 0 0 3px rgba(255, 245, 214, 0.6);
 }
 50% {
 box-shadow:
 0 0 3px rgb(var(--accent) / 0.5),
 0 0 6px rgb(var(--accent) / 0.3),
 0 0 10px rgb(var(--accent) / 0.15),
 ...
 `}</style>
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 30% 30%, #fde6a8, rgb(var(--accent)) 60%, rgb(var(--accent)))",
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          {[
            ...
            <div key={label} className="text-center">
              <div className="bg-bg-primary border border-ink/10 rounded-lg px-3 py-2 min-w-[52px]">
                <span className="text-accent font-mono text-lg lg:text-xl font-bold">
        ...
        <ComposedChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
          ...
          <Tooltip
            content={({ active, payload }) => {
              ...
              if (!d) return null;
              return (
                <div className="bg-surface-raised/95 backdrop-blur-md border border-ink/12 rounded-xl p-3 shadow-xl">
...
export const LivePerformanceStats = ({ data }) => {
 ...
 ════════════════════════════════════════ */}
      <div className="text-center mb-10">
        <div className="flex items-center justify-center gap-3 mb-6">
          <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-text-muted flex items-center gap-2">
        ...
        <p className="text-text-secondary text-base lg:text-lg max-w-2xl mx-auto leading-relaxed">
          Every signal is recorded on-chain since day one. Full history, no hidden trades, no
          cherry-picking —
          ...
          {statCards.map((card, idx) => (
            <div
              ...
              className={`relative overflow-hidden rounded-md p-3 lg:p-4 bg-surface-raised border transition-all ${
                card.isAccent
                  ? "border-ink/12 group-hover:border-ink/18"
                  : "border-ink/[0.06] group-hover:border-ink/10"
              }`}
            >
 ...
 ════════════════════════════════════════ */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 lg:gap-4 mb-4">
        ...
        <div
          onClick={goPerf}
          className="lg:col-span-2 relative overflow-hidden rounded-md p-4 lg:p-6 bg-surface-raised border border-ink/10 hover:border-ink/12 transition-all cursor-pointer"
        >
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="px-2.5 py-1 bg-accent/12 border border-ink/10 rounded-sm">
              <span className="text-accent text-[10px] font-bold uppercase tracking-[0.2em] font-mono">
                Weekly
              </span>
            </div>
          </div>
        ...
        <div
          onClick={goPerf}
          className="lg:col-span-1 relative overflow-hidden rounded-md p-4 lg:p-6 bg-surface-raised border border-ink/10 hover:border-ink/12 transition-all cursor-pointer"
        >
          <span className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-ink/12 to-transparent" />
          <h3 className="text-text-primary font-semibold text-base lg:text-lg mb-1 tracking-tight">
          ...
          {outcomeTotal > 0 ? (
            ...
            <div className="h-32 flex items-center justify-center">
              <div className="w-6 h-6 border-2 border-ink/10 border-t-accent rounded-full animate-spin" />
            </div>
          )}
        </div>
      </div>
 ...
 ════════════════════════════════════════ */}
      <div
        onClick={goPerf}
        className="relative overflow-hidden rounded-md p-4 lg:p-6 bg-surface-raised border border-ink/10 hover:border-ink/12 transition-all mb-4 cursor-pointer"
      >
        <span className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-ink/12 to-transparent" />
              ...
              {riskDist.map((rd) => (
                <div key={rd.risk_level} className="flex items-center gap-1.5">
                  <div
                    ...
                    style={{
                      backgroundColor: (riskColors[rd.risk_level] || riskColors["Normal"]).bar,
                    }}
                  />
                  <span className="text-text-muted text-[10px] font-mono tabular-nums">
                    {riskTotal > 0 ? ((rd.total_signals / riskTotal) * 100).toFixed(0) : 0}%
                  </span>
                </div>
              ))}
            </div>
            ...
            {riskDist.map((rd) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-text-muted text-[10px] mb-3 font-mono">Win Rate</p>
                  {/* Flat segmented bar */}
 ...
 ════════════════════════════════════════ */}
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex-1 p-4 rounded-md bg-surface-secondary border border-ink/10 flex items-center gap-3">
          ...
          <p className="text-text-secondary text-xs lg:text-sm leading-relaxed">
            <span className="text-text-primary font-semibold">Every trade on record.</span> All{" "}
        ...
        <button
          onClick={goPerf}
          className="group relative px-6 py-3.5 rounded-md font-semibold text-sm transition-all hover:-translate-y-0.5 flex items-center justify-center gap-2.5 flex-shrink-0 shadow-[0_4px_14px_rgb(var(--accent) / 0.25)] hover:shadow-[0_6px_18px_rgb(var(--accent) / 0.35)]"
          style={{
            background:
              "linear-gradient(135deg, rgb(var(--accent)) 0%, rgb(var(--accent)) 50%, rgb(var(--accent)) 100%)",
            color: "rgb(var(--surface))",
...
const PhoneFlyingCoins = ({ gainers }) => {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col gap-1 px-4 py-2.5 rounded-2xl border border-ink/12"
        style={{
          background: "rgba(10,5,6,0.85)",
          backdropFilter: "blur(14px)",
          WebkitBackdropFilter: "blur(14px)",
          boxShadow: "0 8px 32px rgb(var(--scrim) / 0.35), 0 0 15px rgb(var(--accent) / 0.15)",
        }}
      >
        <div className="flex items-center gap-2">
          <CoinLogo pair={item.pair} size={20} />
...
const LandingPage = () => {
 ...
 `}</style>
      ...
      <header
        className={`sticky top-0 z-50 transition-all duration-500 ${scrolled ? "bg-surface/85 backdrop-blur-xl border-b border-ink/08 shadow-[0_10px_30px_rgb(var(--scrim) / 0.35)]" : "bg-transparent"}`}
      >
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            >
              ...
              <h1 className="font-display text-lg lg:text-xl font-bold text-text-primary tracking-wide group-hover:text-text-primary transition-colors duration-300">
                LuxQuant
              </h1>
            </div>
            ...
            <nav className="hidden lg:flex flex-1 justify-center items-center gap-8">
              {[
                ...
                >
                  {label}
                  <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-gradient-to-r from-transparent via-ink to-transparent transition-all duration-500 group-hover:w-[80%] opacity-0 group-hover:opacity-100"></span>
                </button>
              ))}
            </nav>
            ...
            <div className="hidden lg:flex flex-1 justify-end items-center">
              <button
                ...
                className="group relative px-6 py-2.5 rounded-md font-semibold transition-all hover:-translate-y-0.5 flex items-center gap-2 shadow-[0_4px_14px_rgb(var(--accent) / 0.2)] hover:shadow-[0_6px_18px_rgb(var(--accent) / 0.3)]"
                style={{
                  background:
                    "linear-gradient(135deg, rgb(var(--accent)) 0%, rgb(var(--accent)) 50%, rgb(var(--accent)) 100%)",
                  color: "rgb(var(--surface))",
            ...
            <div className="flex-1 flex justify-end lg:hidden">
              ...
              >
                <div className="w-5 h-4 flex flex-col justify-between">
                  <span
                    className={`block h-0.5 bg-current rounded-full transition-all duration-300 ${mobileMenuOpen ? "rotate-45 translate-y-[7px] text-accent" : ""}`}
                  />
                  <span
        ...
        <div
          className={`lg:hidden absolute top-full left-0 w-full bg-surface/95 backdrop-blur-3xl overflow-hidden transition-all duration-500 ease-in-out ${mobileMenuOpen ? "max-h-[400px] opacity-100 border-b border-ink/10 shadow-2xl" : "max-h-0 opacity-0"}`}
        >
          <div className="px-6 py-6 space-y-2">
            {[
              ...
              <button
                key={id}
                onClick={() => scrollTo(id)}
                className="block w-full text-left text-text-primary/70 hover:text-text-primary hover:bg-ink/[0.03] px-4 py-3 rounded-xl text-sm font-medium tracking-wide transition-colors"
              >
                {label}
              </button>
            ))}
 ...
 ════════════════════════════════════════ */}
      ...
      >
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] pointer-events-none -z-10">
          <div
            className="absolute inset-0 bg-accent/[0.025] rounded-full blur-[160px]"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-8 items-center relative z-10">
          <div className="relative z-20 flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            >
              An{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-ink to-accent-dark">
                Algorithm
              </span>
              <br />
              Built to Outsmart
            ...
            >
              Our algorithm runs <span className="text-text-primary font-medium">24/7</span> —
              scanning price action, derivatives flow, on-chain whale movements, and order book
              liquidity to deliver precision projection and strict risk management.
              <br />
              <br />
              Complemented by an{" "}
              <span className="text-text-primary font-medium">AI market researcher</span> that
              synthesizes sentiment and macro events into one clear verdict.
            </p>
            ...
            >
              ...
              <button
                onClick={isAuthenticated ? goTerminal : goLogin}
                className="group relative px-7 py-3.5 rounded-md font-semibold text-sm transition-all hover:-translate-y-0.5 flex items-center gap-2.5 shadow-[0_4px_14px_rgb(var(--accent) / 0.25)] hover:shadow-[0_6px_18px_rgb(var(--accent) / 0.35)]"
                style={{
                  background:
                    "linear-gradient(135deg, rgb(var(--accent)) 0%, rgb(var(--accent)) 50%, rgb(var(--accent)) 100%)",
                  color: "rgb(var(--surface))",
          ...
          >
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-accent/20 to-[#8b1a1a]/10 blur-[80px] rounded-full mix-blend-screen pointer-events-none z-0" />
            ...
            <div className="relative w-full max-w-[320px] sm:max-w-[450px] lg:max-w-full xl:max-w-[650px] mx-auto mt-2 lg:mt-0">
              ...
              >
                <div className="relative w-full aspect-[16/10] bg-surface-raised rounded-t-xl lg:rounded-t-[2rem] border-t-[4px] border-l-[4px] border-r-[4px] lg:border-t-[8px] lg:border-l-[8px] lg:border-r-[8px] border-surface-hover overflow-hidden shadow-[0_20px_50px_rgb(var(--scrim) / 0.8),0_0_30px_rgb(var(--accent) / 0.15)]">
              ...
              <div className="absolute -bottom-4 -right-2 sm:-bottom-8 lg:-bottom-12 sm:-right-4 lg:-right-8 z-30 flex-shrink-0 w-[120px] sm:w-[160px] lg:w-[200px] xl:w-[220px] aspect-[9/19.5]">
                ...
                >
                  <div className="absolute inset-0 bg-black rounded-[1.8rem] lg:rounded-[2.8rem] border-[4px] lg:border-[6px] border-surface-hover overflow-hidden shadow-[0_25px_60px_rgb(var(--scrim) / 0.9),0_0_40px_rgb(var(--accent) / 0.3)]">
                    <div className="absolute top-0 inset-x-0 z-30">
 ...
 ════════════════════════════════════════ */}
      ...
      >
        <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[80%] h-40 bg-accent/12 blur-[120px] pointer-events-none rounded-full" />
        <div className="text-center mb-8 relative z-10">
          ...
          <p className="text-text-secondary text-base lg:text-lg max-w-2xl mx-auto leading-relaxed">
            Witness the algorithmic edge. Here are the most recent setups successfully identified
            and signaled by our quantitative engine{" "}
            <span className="text-text-primary font-medium">with massive upside potential</span>.
          </p>
        </div>
        <div className="relative mt-2">
          <div className="absolute -inset-4 bg-gradient-to-b from-accent/5 to-transparent rounded-3xl blur-md -z-10" />
          <TopPerformers />
        </div>
        <div className="mt-8 flex flex-row items-center justify-center gap-2 text-xs lg:text-sm text-text-muted">
          ...
          <span>
            <span className="text-accent font-medium">Tip:</span> Click any coin to view its
            original signal & results.
          </span>
        </div>
      </section>
 ...
 ════════════════════════════════════════ */}
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-[600px] bg-surface-secondary rounded-[100%] blur-[120px] pointer-events-none -z-10" />
        ...
        <div className="hidden lg:flex items-center justify-center max-w-[1200px] mx-auto w-full relative z-10">
          <div className="flex flex-col gap-3 w-[220px] xl:w-[260px] flex-shrink-0 z-20">
            {[
              ...
              <div
                key={i}
                className="group bg-surface-raised backdrop-blur-md border border-ink/5 hover:border-ink/12 p-4 rounded-md transition-all duration-300 relative overflow-hidden"
              >
                <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-accent/20 group-hover:bg-accent transition-colors" />
                <span className="text-text-muted font-mono text-[9px] mb-1 block">{node.id}</span>
          ...
          <div className="flex-1 h-px bg-gradient-to-r from-accent/20 to-transparent relative mx-2 xl:mx-4 flex-shrink-1 min-w-[30px]">
            <div
              className="absolute top-[-1px] left-0 w-1/2 h-[3px] bg-accent rounded-full shadow-[0_0_10px_rgb(var(--accent))]"
          ...
          <div className="relative flex items-center justify-center flex-shrink-0 z-20 mx-2">
            ...
            <div className="absolute w-[180px] h-[180px] xl:w-[210px] xl:h-[210px] rounded-md border border-ink/08" />
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-gradient-to-b from-transparent via-ink/10 to-transparent w-full h-[20%]"
                style={{ animation: "scanline 3s linear infinite" }}
              />
              <div className="w-12 h-12 xl:w-14 xl:h-14 rounded-md border border-ink/12 flex items-center justify-center mb-3 bg-surface-secondary">
                <svg
                  className="w-6 h-6 xl:w-7 xl:h-7 text-accent"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <p className="text-text-muted font-mono text-[7px] xl:text-[8px] mt-1 uppercase tracking-[0.2em]">
                Quantum Engine
              </p>
            </div>
          </div>
          ...
          <div className="w-[120px] xl:w-[140px] bg-surface border border-ink/10 rounded-md flex flex-col items-center justify-center p-4 relative z-20 flex-shrink-0 hover:-translate-y-0.5 transition-transform">
            <svg
              className="w-6 h-6 text-text-muted mb-3"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div className="relative w-[240px] xl:w-[280px] flex-shrink-0 z-20">
            <div className="bg-surface-raised rounded-md border border-ink/10 p-5 relative overflow-hidden">
              ...
              <div className="space-y-3 font-mono">
                <div className="flex justify-between items-end border-b border-ink/5 pb-2">
                  ...
                  <span className="text-accent text-[9px]">200 OK</span>
                </div>
                <div className="flex justify-between items-end border-b border-ink/5 pb-2">
                  <div>
                    <p className="text-text-muted text-[8px] uppercase tracking-wider mb-0.5">
                  ...
                  <span className="text-accent text-[9px]">Pushed</span>
                </div>
        ...
        <div className="flex lg:hidden flex-col items-center w-full relative z-10">
          <div className="grid grid-cols-2 gap-3 w-full max-w-[320px] relative z-20">
            {[
              ...
              >
                <span className="text-text-muted font-mono text-[7px] mb-1 block">{node.id}</span>
          ...
          <div className="w-px h-8 bg-ink/10 relative my-1">
            <div
              className="absolute top-0 left-[-1px] w-[3px] h-1/2 bg-accent rounded-full shadow-[0_0_10px_rgb(var(--accent))]"
          ...
          <div className="relative w-48 h-48 flex items-center justify-center z-20 my-4">
            <div className="absolute w-[200px] h-[200px] rounded-md border border-ink/08" />
            <div
          ...
          <div className="bg-surface-raised rounded-md border border-ink/10 p-4 w-full max-w-[320px] relative z-20 overflow-hidden">
            ...
            <div className="space-y-2 font-mono">
              <div className="flex justify-between items-end">
                ...
                <span className="text-accent text-[9px]">Pushed to UI</span>
              </div>
            </div>
          </div>
        </div>
 ...
 ════════════════════════════════════════ */}
      <footer className="relative z-10 bg-bg-primary overflow-hidden">
        {/* Ambient gold glow */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-surface-secondary blur-[160px] rounded-full pointer-events-none" />

        {/* Top hairline */}
        <div className="h-px bg-gradient-to-r from-transparent via-ink/12 to-transparent" />
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 pt-10 lg:pt-12 pb-8">
          <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 mb-10">
            ...
            <div className="col-span-1 lg:col-span-2 lg:col-start-6">
              <p className="font-mono text-[10px] uppercase tracking-[0.25em] text-text-muted mb-5 flex items-center gap-2">
            ...
            <div className="col-span-1 lg:col-span-2 lg:col-start-8">
              ...
              <ul className="space-y-3">
                {[
                  {
                    label: "Open Terminal",
                    action: () => (isAuthenticated ? goTerminal() : goLogin()),
                  },
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-text-primary text-sm font-semibold leading-none mb-1">
                      Telegram
                    </p>
                  ...
                  <svg
                    className="w-3.5 h-3.5 text-text-primary/30 group-hover:text-text-primary group-hover:translate-x-0.5 transition-all flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
 ...
 STICKY MOBILE CTA
 ════════════════════════════════════════ */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 p-4 bg-bg-primary/95 backdrop-blur-xl border-t border-ink/10 z-[100]">
        <button
          onClick={isAuthenticated ? goTerminal : goLogin}
          className="w-full py-3.5 rounded-md font-semibold text-sm flex justify-center items-center gap-2 uppercase tracking-wide transition-transform active:scale-[0.98] shadow-[0_4px_14px_rgb(var(--accent) / 0.25)]"
          style={{
            background:
              "linear-gradient(135deg, rgb(var(--accent)) 0%, rgb(var(--accent)) 50%, rgb(var(--accent)) 100%)",
            color: "rgb(var(--surface))",

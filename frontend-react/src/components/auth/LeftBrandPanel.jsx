...
const getTaglines = (t) => {
  ...
  return [
    {
      parts: [
        { text: a("tagline_1_a"), g: false },
        { text: a("tagline_1_b"), g: true },
        { text: a("tagline_1_c"), g: false },
      ],
    },
    {
      parts: [
        { text: a("tagline_2_a"), g: false },
        { text: a("tagline_2_b"), g: true },
        { text: a("tagline_2_c"), g: false },
      ],
    },
    {
      parts: [
        { text: a("tagline_3_a"), g: false },
        { text: a("tagline_3_b"), g: true },
        { text: a("tagline_3_c"), g: false },
      ],
    },
  ];
};
...
export const TypewriterLine = ({ mobile }) => {
  ...
  return (
    <div style={{ textAlign: mobile ? "left" : "center", minHeight: mobile ? 44 : 40 }}>
      ...
      >
        {parts.map((p, i) => (
          <span key={i} style={{ color: p.g ? "rgb(var(--accent))" : "#8a7d73" }}>
            {p.text}
          </span>
        ))}
        <span
 ...
 `}</style>
      <div
        ...
        style={{
          ...
          height: "120%",
          background:
            "radial-gradient(ellipse at center, rgb(var(--accent) / 0.13) 0%, transparent 64%)",
        }}
      />
      ...
      <div className="relative">
        <div
          className="relative overflow-hidden rounded-[12px] bg-black ring-1 ring-ink/[0.07]"
          style={{
            boxShadow: "0 36px 80px rgb(var(--scrim) / 0.35), 0 0 56px rgb(var(--accent) / 0.10)",
          }}
        >
          <div style={{ padding: compact ? 6 : 9 }}>
            <div
              className="relative overflow-hidden rounded-[3px] bg-surface ring-1 ring-ink/[0.05]"
          ...
          <div
            className="flex items-center justify-center bg-gradient-to-b from-text-primary via-[#d8dadd] to-[#c4c6ca]"
            style={{ height: compact ? 18 : 26 }}
          >
            <AppleLogo
              className={
                compact ? "h-[9px] w-[9px] text-surface" : "h-[13px] w-[13px] text-surface"
              }
            />
          </div>
        </div>
        <div className="relative mx-auto -mt-px" style={{ width: "34%", maxWidth: 180 }}>
          <svg viewBox="0 0 150 50" className="block h-auto w-full" aria-hidden="true">
            ...
            <path
              ...
              fill="url(#lqAuthStand)"
            />
          </svg>
        </div>
        <div
          aria-hidden="true"
          className="mx-auto -mt-1 rounded-[50%] bg-scrim/50 blur-md"
          style={{ height: compact ? 8 : 12, width: "32%" }}
        />
      </div>
      ...
      {phone && (
        <div
          ...
          style={{
            ...
            minWidth: 68,
            maxWidth: 150,
            animation: "lq-float-p 5s ease-in-out infinite 0.8s",
          }}
        >
          <div
            className="relative overflow-hidden rounded-[1.5rem] bg-black p-[2px] ring-1 ring-ink/10"
            style={{
              boxShadow: "0 24px 50px rgb(var(--scrim) / 0.85), 0 0 34px rgb(var(--accent) / 0.18)",
            }}
          >
            <div
              className="relative overflow-hidden rounded-[1.35rem] bg-surface"
            ...
            >
              ...
              />
              <div
                className="absolute left-1/2 top-[2.4%] z-20 -translate-x-1/2 rounded-full bg-black"
                style={{ width: "32%", aspectRatio: "3.4 / 1" }}
              />
              <div
                className="absolute bottom-[1.6%] left-1/2 z-20 -translate-x-1/2 rounded-full bg-ink/25"
                style={{ width: "34%", height: 2 }}
              />
            </div>
          </div>
        </div>
...
const ASSETS = [
  ...
  }, // HYPE (Hyperliquid)
  {
    ...
    contain: true,
    pad: 8,
  }, // NVIDIA — real eye logo on brand-green coin
  {
    ...
    contain: true,
    pad: 9,
  }, // SAMSUNG (tokenized stock)
  {
    src: "https://cdn.simpleicons.org/amd/ffffff",
    fb: "A",
    bg: "#0b0b0c",
    fbColor: "#ffffff",
    contain: true,
    ...
    >
      {ASSETS.map((c, i) => (
        <span
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.zIndex = String(10 - i);
          }}
        >
          {/* gold halo */}
          <span
            ...
            style={{ boxShadow: "0 0 22px 4px rgb(var(--accent) / 0.5)" }}
          />
          {/* coin (tilts in 3D on hover) */}
          <span
            className="relative flex items-center justify-center overflow-hidden rounded-full transition-transform duration-300 ease-out will-change-transform group-hover:[transform:rotateX(16deg)_rotateY(-16deg)_scale(1.16)]"
          ...
          >
            ...
            <span
              ...
              style={{ color: c.fbColor, fontSize: size * 0.4, opacity: c.src ? 0 : 1 }}
            >
              {c.fb}
            </span>
            {c.src && (
              <img
                ...
                style={{
                  objectFit: c.contain ? "contain" : "cover",
                  padding: c.contain ? Math.round(((c.pad ?? 6) * size) / 40) : 0,
                }}
                onError={(e) => {
                  e.currentTarget.style.display = "none";
                  const fb = e.currentTarget.previousElementSibling;
            ...
            <span
              aria-hidden="true"
              className="pointer-events-none absolute inset-0 rounded-full opacity-0 transition-opacity duration-300 group-hover:opacity-100"
              style={{ boxShadow: "inset 0 0 0 2px rgb(var(--accent) / 0.95)" }}
            />
          </span>
        </span>
      ))}
      <span
        ...
        style={{
          height: size,
          paddingInline: Math.round(size * 0.35),
          marginLeft: -overlap,
          background: "rgb(var(--surface-hover))",
          color: "rgb(var(--fg-secondary))",
          fontSize: Math.round(size * 0.31),
          boxShadow: "0 0 0 3px #160608",
        }}
      >
        +more
      </span>
...
const MARKETS = [
  {
    ...
    icon: (
      <svg
        ...
        aria-hidden="true"
      >
        <rect x="4" y="9" width="3.2" height="8" rx="1" />
        <rect x="5" y="6" width="1.2" height="14" rx="0.6" />
        <rect x="10.4" y="6" width="3.2" height="11" rx="1" />
        <rect x="11.4" y="3" width="1.2" height="18" rx="0.6" />
        <rect x="16.8" y="10.5" width="3.2" height="5.5" rx="1" />
        <rect x="17.8" y="8" width="1.2" height="11" rx="0.6" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M12 2.2 22 7.4v2H2v-2z" />
        <rect x="4" y="11" width="2.6" height="6.4" rx="0.5" />
        <rect x="9" y="11" width="2.6" height="6.4" rx="0.5" />
        <rect x="14" y="11" width="2.6" height="6.4" rx="0.5" />
        <rect x="18.4" y="11" width="2" height="6.4" rx="0.5" />
        <rect x="2.2" y="18.6" width="19.6" height="2.6" rx="0.7" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <rect x="10.3" y="2.4" width="1.5" height="3" rx="0.4" />
        <rect x="13.2" y="2.4" width="1.5" height="3" rx="0.4" />
        <rect x="10.3" y="18.6" width="1.5" height="3" rx="0.4" />
        <rect x="13.2" y="18.6" width="1.5" height="3" rx="0.4" />
        <rect x="2.4" y="10.3" width="3" height="1.5" rx="0.4" />
        <rect x="2.4" y="13.2" width="3" height="1.5" rx="0.4" />
        <rect x="18.6" y="10.3" width="3" height="1.5" rx="0.4" />
        <rect x="18.6" y="13.2" width="3" height="1.5" rx="0.4" />
      </svg>
    ),
  },
];
      ...
      <div className="hidden lg:flex lg:w-[55%] relative flex-col">
        <div className="relative z-10 flex h-full flex-col px-10 xl:px-16 pt-9 pb-14">
          ...
          <div className="text-center">
            <p
              className="mb-5 font-mono uppercase tracking-[0.22em]"
              style={{ color: "rgb(var(--fg-muted))", fontSize: 11 }}
            >
              All Markets, One Edge
            </p>
            <div
              className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3"
              style={{ color: "rgb(var(--fg-secondary))", fontSize: 13.5 }}
            >
              {MARKETS.map((m) => (

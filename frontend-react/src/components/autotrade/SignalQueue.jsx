    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <button
          type="button"
          onClick={load}
          className="inline-flex items-center gap-1.5 rounded-md border border-ink/[0.06] px-2.5 py-1 font-mono text-[10px] uppercase tracking-[0.15em] text-gold-primary/80 transition-all hover:border-line/30 hover:text-gold-primary"
        >
          <svg

...
export default function TradeHistoryCalendar({ history = {} }) {
 ...
 <Card>
 <div className="mb-4">
 <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-accent">Cumulative performance</p>
 ...
 <Card>
 <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-accent">Outcome mix</p>
 <div className="h-52">
 <ResponsiveContainer width="100%" height="100%">
 <PieChart>
 ...
 <div>
 <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-accent">Daily result</p>

...
import { sendTestAlert, updateAlertPreferences } from "../../services/autotradeApi";
import { Card, GhostButton, GoldButton, Notice, StatusDot, Toggle } from "./AutoTradeUI";
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <h2 className="mt-0.5 text-lg font-semibold text-text-primary">Telegram alerts</h2>
          ...
          <p className="mt-3 max-w-2xl text-xs leading-5 text-text-muted">
            Choose which operational events are delivered privately through LuxQuantTerminalBot.
          </p>
        </div>

      ...
      <div className="relative p-5">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] font-mono text-text-muted mt-0.5">{account.label || "Unnamed"}</p>
            </div>
          </div>
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="text-[10px] font-mono uppercase tracking-[0.15em] text-gold-primary/80 hover:text-gold-primary disabled:opacity-50 flex items-center gap-1 transition-colors"
            >
              <svg
        ...
        {testResult && (
          <div
            className={`mb-3 rounded border text-[11px] font-mono p-2.5 ${
              testResult.success
                ? "bg-emerald-500/[0.05] border-emerald-500/25 text-emerald-400"
                : "bg-red-500/[0.05] border-red-500/25 text-red-400"
            }`}
          >
            {testResult.success
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-3 py-2 rounded-md border border-red-500/25 text-red-400 hover:bg-red-500/[0.08] hover:border-red-500/40 transition-all"
            title="Disconnect"
          >

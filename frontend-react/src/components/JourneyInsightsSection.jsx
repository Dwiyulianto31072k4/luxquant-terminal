...
const JourneyInsightsSection = ({ pair }) => {
 ...
 <Cell>
 <span className={`text-[11px] font-mono ${row.avg_dd_pct < 0 ? "text-loss" : "text-text-primary/40"}`}>
 ...
 <tr key={row.tp} className="border-b border-ink/[0.03] last:border-0">
 <Cell>
 <span className={`text-[11px] font-bold ${isSL ? "text-loss" : "text-text-primary"}`}>{row.tp}</span>
 </Cell>
 <Cell>
 ...
 <Cell>
 <span className={`text-[11px] font-mono ${isSL ? "text-loss" : "text-profit"}`}>

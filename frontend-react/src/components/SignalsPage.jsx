...
const SignalsPage = () => {
  ...
  }, [allSignals, searchPair, statusFilter, riskFilter, sortBy, sortOrder, page, pageSize]);
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-text-muted text-sm">
            ...
            <span>
              {loading ? 'Loading...' : lastUpdated ? `${lastUpdated.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}` : 'Ready'}
            </span>
          </div>
        </div>
      </div>

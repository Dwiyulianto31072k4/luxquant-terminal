...
const BtcDomAlert = ({ allSignals, onSignalClick }) => {
 ...
 : btcdomSignal.risk_level?.toLowerCase().startsWith('high') ? '#ef4444' : 'rgb(var(--accent))';
 ...
 <p className="font-mono text-[15px] font-semibold leading-none text-loss/90">{formatPrice(btcdomSignal.stop1)}</p>
 </div>
 <div className="w-px bg-ink/[0.06]" />
 <div className="flex-1 px-4 py-3">
 ...
 <br className="hidden sm:block" /> <span className="text-loss">sell your altcoins.</span>
 </p>

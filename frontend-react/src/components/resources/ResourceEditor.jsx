...
const ResourceEditor = ({ resource, categories = [], onClose, onSaved }) => {
 ...
 className="lq-modal-safe lq-scrim-bg fixed inset-0 z-[10000] flex items-end justify-center sm:items-center p-0 sm:p-4"
      onClick={onClose}
    >
      <div
        className="lq-sheet bg-bg-secondary rounded-t-3xl sm:rounded-2xl border-t border-ink/10 sm:border max-w-2xl w-full max-h-[min(var(--lq-modal-maxh),100%)] overflow-y-auto shadow-[0_-20px_60px_rgb(var(--scrim) / 0.35)]"

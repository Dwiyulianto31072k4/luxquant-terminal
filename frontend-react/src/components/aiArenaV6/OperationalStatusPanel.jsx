...
const statusTone = {
  ...
  unknown: {
    badge: "border-ink/15 bg-ink/5 text-text-muted",
  ...
  return (
    <div className="min-w-0 rounded-xl border border-ink/[0.06] lq-well p-3.5">
      <div className="flex min-w-0 items-center gap-2">
        ...
        <span className="truncate text-[11px] font-mono uppercase tracking-[0.12em] text-text-muted">
...
function AlertRow({ alert }) {
  return (
    <div className="rounded-lg border border-ink/[0.06] lq-well-soft px-3 py-2.5">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <span className="text-xs text-text-primary">{alert.title}</span>
        {alert.runbook && (
          <span className="ml-auto text-[9px] font-mono uppercase text-text-muted">
            runbook: {alert.runbook}
          </span>
        )}
      </div>
      <p className="mt-1 text-[10px] leading-relaxed text-text-muted">{alert.detail}</p>
    </div>
  );
}
  ...
  return (
    <section className="min-w-0 rounded-2xl border border-ink/10 bg-surface-secondary/90 p-4 md:p-6">
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-xl border border-ink/[0.06] lq-well-soft p-3.5">
        ...
        <div className="rounded-xl border border-ink/[0.06] lq-well-soft p-3.5">
          ...
          <div className="mt-3 space-y-2 text-[11px] font-mono text-text-muted">

...
export default function InstitutionalFlowRadar() {
  ...
  if (loading) {
    return (
      <div className="glass-card rounded-2xl p-6 border border-ink/08">
        ...
        <div className="h-32 flex items-center justify-center">
          <div className="w-6 h-6 border-2 border-ink/12 border-t-white/50 rounded-full animate-spin" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="glass-card rounded-2xl p-6 border border-ink/08">
        ...
        <div className="text-text-muted text-sm py-4">
          ...
          <button
            onClick={fetchData}
            className="ml-3 px-3 py-1 text-[10px] uppercase tracking-wider rounded border border-ink/12 text-text-primary hover:bg-ink/[0.06] transition-colors"
          >
            Retry
          </button>
        </div>
    ...
    <div className="glass-card rounded-2xl p-6 border border-ink/08">
      ...
      <div className="flex items-start justify-between flex-wrap gap-3 mb-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="px-2 py-0.5 rounded-full text-[9px] font-bold tracking-wider uppercase border bg-ink/[0.06] border-ink/12 text-text-primary">
            Live
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        ...
        <div className="bg-bg-card/50 rounded-xl p-3 border border-ink/5">
          ...
          <div className="text-[10px] text-text-muted mt-0.5">{flows.last_date || "—"}</div>
        </div>
        ...
        <div className="bg-bg-card/50 rounded-xl p-3 border border-ink/5">
          ...
          >
            {streakDays}d
            <span className="text-xs opacity-70">{streakDir === "inflow" ? "↑" : "↓"}</span>
          </div>
          <div className="text-[10px] text-text-muted mt-0.5 capitalize">{streakDir || "—"}</div>
        </div>
      ...
      <div className="mb-5">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[9px] text-text-muted font-mono">in millions USD</span>
        </div>
      ...
      <div className="mt-5 pt-4 border-t border-ink/5">
        <p className="text-[11px] text-text-muted leading-relaxed">
          {(() => {
            ...
            const streakNarr =
              streakDays >= 3 ? ` Streak of ${streakDays}d ${streakDir} reinforces the trend.` : "";

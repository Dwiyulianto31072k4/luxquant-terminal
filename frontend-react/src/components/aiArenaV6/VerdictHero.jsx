  ...
  return (
    ...
    >
      ...
      >
          ...
          style={{
            color:
              dataHealth?.support === "supported"
                ? COLORS.bullish
                : dataHealth?.support === "conflicted" || dataHealth?.support === "unavailable"
                  ? COLORS.bearish
        ...
        >
          Data:{" "}
          {dataHealth?.support || (label === "Cycle context" ? "context only" : "unavailable")}
        </span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {report.report_id && (
          <span style={{ marginLeft: "auto", color: COLORS.textFaint }}>{report.report_id}</span>
        )}
      </div>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
        <HorizonCard
          label="Cycle context"
          horizonLabel="SLOW MARKET BACKDROP"
          verdict={primary30d}
        />
        <HorizonCard
          label="Swing"
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
        ...
        />
        <StatChip label="Cycle Phase" value={cycle.phase || "—"} valueColor={primaryColor} />
        <StatChip
          label="Cycle Score"

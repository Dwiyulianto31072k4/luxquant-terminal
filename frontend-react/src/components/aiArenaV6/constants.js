...
export const COLORS = {
  ...
  border: "rgb(var(--accent) / 0.12)",
  borderSubtle: "rgb(var(--ink) / 0.06)",
  borderStrong: "rgb(var(--accent) / 0.25)",
  ...
  gold: "rgb(var(--accent))",
  goldDim: "rgb(var(--accent) / 0.6)",
  goldBg: "rgb(var(--accent) / 0.08)",
...
export function directionBg(direction) {
  switch ((direction || "").toLowerCase()) {
    case "bullish":
      return COLORS.bullishBg;
    case "bearish":
      return COLORS.bearishBg;
    case "neutral":
...
export function directionBorder(direction) {
  switch ((direction || "").toLowerCase()) {
    case "bullish":
      return COLORS.bullishBorder;
    case "bearish":
      return COLORS.bearishBorder;
    case "neutral":
...
export function outcomeColor(outcome) {
  switch ((outcome || "").toLowerCase()) {
    case "hit":
      return COLORS.outcomeHit;
    case "miss":
      return COLORS.outcomeMiss;
    case "pending":

...
export default function AssistantFullPage() {
 ...
 <p className="mt-1 font-mono text-[10px] uppercase tracking-wider text-text-muted">Full page · feature & data help</p>
 </div>
 </div>
 ...
 Ask anything about how to use the <span className="text-accent font-semibold">{label || 'this'}</span> page. Pick a different topic from the selector above anytime.
 </p>
 ...
 <p className="mt-2 text-center text-[10px] text-text-muted/50">Feature & data guidance — not financial advice.</p>
 </div>
 </div>
 );
}

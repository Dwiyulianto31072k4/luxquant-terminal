...
const ICON_PATHS = {
 ...
 <path d="M6 5.2H4.4a1.8 1.8 0 0 0 0 3.6H6M18 5.2h1.6a1.8 1.8 0 0 1 0 3.6H18" fill="none" stroke="currentColor" strokeWidth="1.5" />
 ...
 <path d="M5.5 5v3M5.5 16v3" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
 <rect x="10.5" y="6" width="3" height="11" rx="1" opacity="0.6" />
 <path d="M12 3v3M12 17v3" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.6" />
 <rect x="17" y="10" width="3" height="6" rx="1" />
 <path d="M18.5 7v3M18.5 16v2" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
 </>
 ),
 d_correlation: (
 <>
 ...
 <path d="M3 20 21 4" fill="none" stroke="currentColor" strokeWidth="1.4" strokeDasharray="2 2" opacity="0.5" />
 </>
 ),
 d_sectors: (
 <>
 ...
 r_calibration: (
 <>
 <circle cx="12" cy="12" r="8.4" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.55" />
 <circle cx="12" cy="12" r="2.3" />
 <path d="M12 1.5v3M12 19.5v3M1.5 12h3M19.5 12h3" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
 </>
 ),
 r_btc: (
 <>
 ...
 <path d="M8 2.5v4M16 2.5v4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
 ...
 r_timing: (
 <>
 <circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" strokeWidth="1.9" opacity="0.6" />
 <path d="M12 7v5l3.4 2" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
 </>
 ),
 r_coins: (
 <>
 <ellipse cx="12" cy="6" rx="7" ry="3" />
 <path d="M5 6v6c0 1.7 3.1 3 7 3s7-1.3 7-3V6" fill="none" stroke="currentColor" strokeWidth="1.6" />
 <path d="M5 12v3c0 1.7 3.1 3 7 3s7-1.3 7-3v-3" fill="none" stroke="currentColor" strokeWidth="1.6" opacity="0.6" />
 </>
 ),
 r_wrbtc: (
 <>
 <path d="M3 17l5-5 4 3 8-9" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
 <path d="M16 5h5v5" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
 </>
 ),
};
const TabIcon = ({ id }) => (
...
const PerformanceHub = () => {
 ...
 const activeItem =
 ALL_ITEMS.find((i) => i.view === view && i.tab === tab) || ALL_ITEMS[0];
 ...
 style={{ background: "rgb(212,168,83)", boxShadow: "0 0 6px rgb(var(--accent) / 0.6)" }}
 />
 )}
 <span className={`flex items-center gap-2.5 ${on ? "text-accent" : "text-accent/45"}`}>
 <TabIcon id={item.id} />
 <span className={on ? "text-accent" : "text-text-primary/85"}>{item.label}</span>
 </span>
 </button>
 );
 })}

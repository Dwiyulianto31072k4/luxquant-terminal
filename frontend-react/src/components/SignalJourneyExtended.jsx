      ...
      <div>
        ...
        <div className="bg-surface-raised rounded-xl border border-ink/5 p-4 text-center">
          <p className="text-text-muted text-xs">
            Price-action data unavailable for this pair. Detailed journey requires kline data from
            Binance or Bybit.
          </p>
        </div>
      </div>
        ...
        <div className="bg-surface-raised rounded-xl border border-ink/5 p-4">
          ...
          {hasMore && (
            <button
              ...
              className="mt-3 w-full py-2 text-[11px] text-accent hover:bg-accent/12 rounded-lg border border-ink/10 hover:border-ink/15 transition-all font-semibold"
            >
              {showAll
        ...
        {outcome && (
          <div className="bg-surface-raised rounded-xl border border-ink/5 p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {outcome.pct_time_above_entry !== null &&
                outcome.pct_time_above_entry !== undefined && (
    ...
    <div className="flex items-start gap-3 relative">
      ...
      <div className="flex-shrink-0 mt-1">
        {confirmed ? (
          ...
          <div
            className={`w-3.5 h-3.5 rounded-full bg-transparent ring-1 ${c.border} ring-2 ring-surface-secondary`}
          >

 ...
 `}</style>
      ...
      {tips.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {tips.map((tip, i) => (
            <div key={tip.id} className={`tip-fade tip-fade-${(i % 6) + 1}`}>
              <div
              ...
              >
                ...
                <div className="relative h-44 overflow-hidden bg-gradient-to-br from-accent/5 to-accent/5">
                  ...
                  >
                    <svg
                      className="w-12 h-12 text-text-muted/40 mb-2"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                    ...
                    <span className="text-text-muted/50 text-xs font-semibold">
                      {t("tips.pdf_module")}
                    </span>
                  </div>
      ...
      {deleteConfirm && (
        ...
        >
          ...
          >
            ...
            <h3 className="text-text-primary font-semibold text-center mb-2">
              {t("tips.del_confirm_title")}
            </h3>
      ...
      {/* PDF Viewer Modal */}
      {selectedTip && (
        <PDFViewerModal tip={selectedTip} onClose={() => setSelectedTip(null)} t={t} />
      )}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="min-w-0">
                <p className="text-text-primary text-sm font-medium truncate">
                  {pdfFile
                    ? pdfFile.name
                    : isEdit
                      ? `${t("tips.current_pdf")} ${tip.pdf_path}`
                      : t("tips.choose_pdf")}
                </p>
                <p className="text-text-muted text-[10px]">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={uploading}
              className="flex-1 py-3 bg-gradient-to-r from-accent to-accent text-bg-primary rounded-xl text-sm font-bold hover: transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {uploading ? (
                <>

...
const MarketHighlights = () => {
 ...
 <p className="text-accent font-mono text-sm font-bold">{formatLargeNumber(overview.altcoinMarketCap)}</p>
 </div>
 ...
 <button className="text-text-muted text-[10px] hover:text-text-primary transition-colors">More</button>
 </div>
 <div className="divide-y divide-accent/5">
 {marketData.topGainer?.slice(0, 2).map((coin, idx) => (
 <div key={idx} className="flex items-center justify-between px-3 py-2 hover:bg-accent/10 cursor-pointer transition-colors">
 <div className="flex items-center gap-2">

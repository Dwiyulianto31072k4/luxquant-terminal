...
const HelpSupportModal = ({ isOpen, onClose }) => {
 ...
 <div
 className="h-24 w-24 rounded-full bg-gradient-to-br from-accent via-ink to-accent p-[3px]"
 style={{ boxShadow: "0 0 20px rgb(var(--accent) / 0.4), 0 0 40px rgb(var(--accent) / 0.15)" }}
 >
 {!imgFailed ? (
 <img
 ...
 <span className="text-2xl font-bold text-accent">LQ</span>
 </div>
 )}
 </div>
 </div>
 ...
 <div className="mb-4 inline-flex items-center gap-1.5 rounded-full border border-ink/10 bg-accent/12 px-2.5 py-1">
 ...
 className="group flex w-full items-center justify-center gap-2.5 rounded-xl bg-gradient-to-r from-accent via-ink to-accent py-3 text-sm font-bold text-bg-primary shadow-lg shadow-accent/20/20 transition-all duration-200 hover:scale-[1.01] hover:shadow-accent/20/40 active:scale-[0.99]"
 >

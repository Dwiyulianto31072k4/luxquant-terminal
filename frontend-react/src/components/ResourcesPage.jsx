...
const ResourcesPage = () => {
 ...
 {isAdmin && (
 <button onClick={() => setEditing({})} className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-accent to-accent text-bg-primary rounded-xl text-sm font-bold hover: transition-all">

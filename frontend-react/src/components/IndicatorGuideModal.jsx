      ...
      >
        ...
        <div className="px-5 sm:px-7 py-5 space-y-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3.5">
            {indicators.map((ind) => (
              <div key={ind.name} className="flex flex-col bg-[#0d0d0d] border border-white/[0.06] rounded-xl p-4 hover:border-gold-primary/20 transition-colors">
        ...
        {/* ─── Footer ─── */}
        <div className="sticky bottom-0 bg-[#0a0506]/95 backdrop-blur border-t border-gold-primary/15 px-5 sm:px-7 py-3 flex items-center justify-between">

 ...
 className="lq-modal-safe lq-scrim-bg fixed inset-0 z-[200000] flex items-end justify-center p-0 sm:items-center sm:p-6"
    ...
    >
      <div
        ref={panelRef}
        tabIndex={-1}
        className="lq-sheet flex max-h-[var(--lq-modal-maxh)] w-full max-w-[1120px] flex-col overflow-hidden rounded-t-2xl border border-ink/[0.1] bg-surface-raised shadow-2xl shadow-black/60 sm:rounded-2xl"

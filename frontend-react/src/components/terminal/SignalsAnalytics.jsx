...
export default function SignalsAnalytics() {
 ...
 dayBuckets.length === 7 ? "text-accent font-semibold" : "text-text-muted/45 hover:text-text-primary"
 }`}
 >
 7D
 </button>
 ...
 <ReferenceLine x={0} stroke="rgb(var(--accent) / 0.35)" strokeDasharray="4 4" />
 {agg.medFlow > 0 && (
 <ReferenceLine
 y={agg.medFlow * 3}

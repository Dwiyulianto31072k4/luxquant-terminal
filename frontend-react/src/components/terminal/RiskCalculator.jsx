...
export function RiskTab({ view, deriv }) {
 ...
 const inputCls = "w-full bg-surface-secondary border border-ink/[0.12] rounded-md px-3 py-2 text-[13px] text-text-primary font-mono focus:outline-none focus:border-ink/18";

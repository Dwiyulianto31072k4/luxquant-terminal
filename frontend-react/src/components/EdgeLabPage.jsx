...
const EdgeLabPage = ({ activeTab: controlledTab, onTabChange, hideTabBar } = {}) => {
 ...
 style={{
 background: "linear-gradient(135deg, #ffffff 0%, rgb(var(--ink) / 0.7) 60%, rgb(var(--accent) / 0.85) 100%)",
 ...
 <div className="text-[10px] tracking-[0.2em] font-mono uppercase text-loss/80 mb-1">· Error ·</div>
 {error}
 </div>
 )}
 ...
 {[...Array(4)].map((_, i) => (
 <div key={i} className="h-[110px] rounded-lg bg-surface-raised border border-ink/[0.06] animate-pulse" />
 ))}
 </div>

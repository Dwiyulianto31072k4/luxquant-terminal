...
function AppContent() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex items-center justify-between h-14 lg:h-16">
            ...
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <div className="flex items-center gap-1.5 px-2 lg:px-3 py-1 lg:py-1.5 bg-positive/10 border border-positive/30 rounded-lg">
                ...
                <span className="text-[10px] lg:text-xs font-semibold text-positive uppercase">
                  Live
                </span>
              </div>
      ...
      {/* Slide-in panel */}
      <div
        className={`fixed top-14 left-0 bottom-0 w-72 z-50 bg-bg-primary border-r border-gold-primary/10 transform transition-transform duration-300 ease-in-out lg:hidden ${
        ...
        <div className="flex items-center justify-around h-16 px-1">
          {bottomNavItems.map((item) => (
            ...
            >
              ...
              <span
                className={`text-[10px] font-medium ${activeTab === item.key ? "text-gold-primary" : ""}`}
              >
                {item.label}
              </span>
              {activeTab === item.key && (

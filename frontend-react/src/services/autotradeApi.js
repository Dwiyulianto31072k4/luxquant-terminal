...
function formatErrorDetail(errorBody, status) {
  ...
  if (d && typeof d === "object") {
    return {
      ...
      code: d.code || null,
      retryAfterSeconds: typeof d.retry_after_seconds === "number" ? d.retry_after_seconds : null,
      detail: d,
    };
  }
  if (typeof d === "string") {
...
export const getTradeHistory = () => request("/me/trade-history");
...
export const getAlertStatus = () => request("/me/alerts");
